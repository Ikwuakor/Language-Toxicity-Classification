...
### To see the full notebook complete with my code where I created my random search algorithms, and a demo where you can score your own user inputted text, click <a href="https://github.com/Ikwuakor/Language-Toxicity-Classification/blob/main/Language%20Toxicity%20Classification.ipynb">here</href>.
